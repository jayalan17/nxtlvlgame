...
export default class TankMenu extends Phaser.State {
  ...
  create () {
    ...
    this.startButton = this.add.sprite(600, 400, 'startButton');
    this.physics.arcade.enable(this.startButton);
    this.startButton.body.immovable = true;
    this.startButton.body.collideWorldBounds = true;
  ...
  update () {
    ...
    if (this.physics.arcade.collide(this.player, this.startButton)) {
      this.goToTank();
    }
  }
