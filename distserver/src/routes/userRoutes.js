...
router.route('/changeShovel').put(function (req, res, next) {
  _User2.default.findOne({
    name: req.body.name
  }, function (err, user) {
    if (err) next(err);
...
router.route('/changeSeeds').put(function (req, res, next) {
  _User2.default.findOne({
    name: req.body.name
  }, function (err, user) {
    if (err) next(err);
...
router.route('/changeWater').put(function (req, res, next) {
  _User2.default.findOne({
    name: req.body.name
  }, function (err, user) {
    if (err) next(err);
...
router.route('/changeCounter').put(function (req, res, next) {
  _User2.default.findOne({
    name: req.body.name
  }, function (err, user) {
    if (err) next(err);
